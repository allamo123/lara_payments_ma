...
class FawryPayment extends BaseController implements PaymentInterface
{
    ...
    {
        $this->fawry_url = config('ma-payments.FAWRY_URL');
        $this->fawry_merchant = config('ma-payments.FAWRY_MERCHANT');
        $this->fawry_secret = config('ma-payments.FAWRY_SECRET');
        $this->fawry_display_mode = config('ma-payments.FAWRY_DISPLAY_MODE');
        $this->fawry_pay_mode = config('ma-payments.FAWRY_PAY_MODE');
    ...
    {
        return view('ma::html.fawry', ['model' => $this, 'data' => $data])->render();
    }
