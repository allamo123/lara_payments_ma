...
class KashierPayment extends BaseController implements PaymentInterface
{
    ...
    {
        $this->kashier_url = config("ma-payments.KASHIER_URL");
        $this->kashier_mode = config("ma-payments.KASHIER_MODE");
        $this->kashier_account_key = config("ma-payments.KASHIER_ACCOUNT_KEY");
        $this->kashier_iframe_key = config("ma-payments.KASHIER_IFRAME_KEY");
        $this->kashier_token = config("ma-payments.KASHIER_TOKEN");
        $this->currency = config('ma-payments.KASHIER_CURRENCY');
    ...
    {
        return view('ma::html.kashier', ['model' => $this, 'data' => $data])->render();
    }
