...
class PaytabsPayment extends BaseController implements PaymentInterface
{
    ...
    {
        $this->paytabs_profile_id = config('ma-payments.PAYTABS_PROFILE_ID');
        $this->paytabs_base_url = config('ma-payments.PAYTABS_BASE_URL');
        $this->paytabs_server_key = config('ma-payments.PAYTABS_SERVER_KEY');
        $this->paytabs_checkout_lang = config('ma-payments.PAYTABS_CHECKOUT_LANG');
        $this->currency = config('ma-payments.PAYTABS_CURRENCY');
    ...
    public function pay(
        $amount = null, $user_id = null, $user_first_name = null, $user_last_name = null, $user_email = null, $user_phone = null, $source = null, $card = null
    )
    {
